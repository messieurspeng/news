...
export default {
  ...
  data () {
    ...
    created(){
      ...
      self.$axios({
          method:'get',
          url: 'http://route.showapi.com/109-35?showapi_appid=34477&showapi_sign=cfa5957a730f43d38886bd16469b2a86&channelId=&channelName=&title=足球&page=1&needContent=0&needHtml=1&needAllList=0&maxResult=20&'
      }).then(function(res){
 ...
 methods:{
     ...
     getdata (x) {
      var detailurl = 'http://route.showapi.com/109-35?showapi_appid=34477&showapi_sign=cfa5957a730f43d38886bd16469b2a86&channelId=' + x + '&channelName=&title=足球&page=1&needContent=0&needHtml=0&needAllList=0&maxResult=20&'
      let self = this
      self.$axios({
        method: 'get',
        url: detailurl
